---
title: 조직지식관리 온톨로지 설계 예시
description: 제품과 시장, 규제, 경쟁사를 하나의 관계망으로 잇는 온톨로지 설계 예시. 담당자 개인 파일에 흩어져 있던 지식을 연결하는
  것이 목적이다.
tags:
- domain/ai
pubDate: '2026-04-03'
source: 1. Memory/know/조직지식관리 온톨로지 설계 예시.md
updatedDate: '2026-06-17'
---

> 에스테틱 주사제 수출 기업을 사례로 한 실전 온톨로지 설계
...
- [온톨로지(Ontology)](/notes/온톨로지ontology) — 온톨로지 개념·구성요소의 이론 정의
- [온톨로지와 택소노미](/notes/온톨로지와-택소노미) — 분류 골격(택소노미)과 의미 확장(온톨로지)의 구분
- 팔란티어와 온톨로지 — 이 설계가 차용한 Palantir Foundry 온톨로지 원칙
- gbrain — Legion 볼트의 검색·합성 레이어 — 본 노트의 "Obsidian 온톨로지적 사고"를 실제 구현한 볼트 검색·그래프 도구
